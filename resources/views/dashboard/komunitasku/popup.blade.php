...
<div class="modal fade" id="detailiuranModal" tabindex="-1" role="dialog" aria-labelledby="detailiuranModalLabel"
    ...
    <div class="modal-dialog modal-lg ml-auto modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-center">
                <h4 class="modal-title text-success" id="exampleModalLongTitle">Detail Iuran</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="jenis-iuran" class="col-form-label">Jenis Iuran</label>
                    <div class="mb-2">
                        <input class="form-control form-control-sm mb-2" name="jenis-iuran" type="text" readonly
                            id="jenis-iuran" value="Iuran Awal">
                    </div>

                    <label for="tanggal" class="col-form-label">Tanggal</label>
                    <div class="mb-2">
                        <input class="form-control form-control-sm mb-2" name="tanggal" type="text" readonly
                            id="tanggal" value="1-06-2023">
                    </div>

                    <label for="jumlah-pembayaran" class="col-form-label">Jumlah Pembayaran</label>
                    <div class="mb-2">
                        <input class="form-control form-control-sm mb-2" name="jumlah-pembayaran" type="text"
                            readonly id="jumlah-pembayaran" value="Rp.500.000">
                    </div>
                ...
                <button type="button" class="btn btn-success px-4 float-right"
                    onclick="window.location.href = '{{ route('komunitas.halamanBayarIuran') }}';">
                    Bayar
                </button>
                <button type="button" class="btn btn-danger mr-2 px-4 float-right waves-effect"
                    data-dismiss="modal">
                    Batal
                </button>
            </div>
