            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('konfirmasi-iuran.index') }}">Konfirmasi Iuran</a>
                        </li>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <label for="jumlah-bayaran" class="col-form-label">Jumlah Bayaran</label>
                                    <h5 class="mb-3">Rp.500.000</h5>

                                    <label for="status-konfirmasi" class="col-form-label">Status Konfirmasi</label>
                                    <div>
