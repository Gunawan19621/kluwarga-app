...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('iuranKomunitas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="mb-1 ml-1">
                        <div class="row mb-2">
                            <div class="col-6">
                                <label for="nama_bank" class="col-form-label"
                                    style="font-size: 14px;">1.&nbsp;&nbsp;M-Banking</label>
                                <div class="mb-2">
                    ...
                    <div class="mb-2 ml-1">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-2">
                                    <select class="form-control ml-2" name="nama_wallet" type="text"
                                        id="nama_wallet">
                ...
                <button type="button" class="btn btn-danger mr-2 px-4 float-right"
                    onclick="window.location.href='{{ route('iuranKomunitas.index') }}'">Batal</button>
            </form>
        </div>
    </div>
@endsection
