...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="form-editIuran">
                <div class="form-group">
                    <label for="selectOption">Nama Iuran</label>
                    <select class="form-control" id="select-iuran">
                        <option value="option1">Iuran wajib</option>
                        <option value="option2">Iuran Sukarela</option>
                ...
                <div class="form-group">
                    ...
                    <div class="mb-2">
                        <input class="form-control" name="jumlah" type="text" id="jumlah" value="Rp.500.000">
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectOption">Periode</label>
                    <select class="form-control" id="select-periode">
                        <option value="option1">Satu Kali</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="select-jenis">
                        <option value="option1">Wajib</option>
                        <option value="option2">Sukarela</option>
                        <option value="lainnya">Lainnya</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="select-penanggungjawab">
                        <option value="option1">Pemilik</option>
                        <option value="option2">Penghuni</option>
                        <option value="lainnya">Lainnya</option>
                    </select>
                </div>
