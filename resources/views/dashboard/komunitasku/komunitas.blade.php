                            ...
                            <div class="row">
                                ...
                                <div class="col-3 text-right d-flex justify-content-end align-items-end">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('pengaturanKomunitas.index', ['komunitas_id' => $getKomunitas['id']]) }}">Pengaturan
                                            ??</a>
                                        <a class="dropdown-item"
                                            href="{{ route('komunitas.halamanPengurus', ['komunitas_id' => $getKomunitas['id']]) }}">Pengurus
                                            ??</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-3" id="role-3" role="tabpanel">
                                    ...
                                    <table id="tableWarga" class="table datatable">
                                        ...
                                        <tbody>
                                            @foreach ($rumah as $datarumah)
                                                <tr>
                                                    <td>{{ $datarumah->kode_rumah }}</td>
                                                    <td>{{ $datarumah->pengguna->user['name'] }}</td>
                                                    <td>
                                                    ...
                                                    <td>{{ $datarumah->pengguna['jabatan'] }}</td>
                                                </tr>
                                            @endforeach
                                            ...
                                            {{-- <tr>
                                                    ...
                                                    <td>
                                                        <div class="radio my-2">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="radio1" name="radion1"
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <h4 class="text-center">Undang Member Komunitas</h4>
                                    <p class="text-center">Undang anggota kedalam komunitas dengan
                                        <br>menggunakan link/e-mail di bawah ini
                                    </p>
                                    <div class="">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend"><span class="input-group-text"><i
                                                        class="fa fa-envelope"></i></span></div><input type="email"
                                                id="example-input2-group1" name="example-input2-group1"
                                                class="form-control" placeholder="jbaKSasxsxjncaa" />
                                        </div>
                                        <div class="d-flex justify-content-center"><button type="input"
                                                class="btn btn-danger px-4"><i
                                                    class="mdi mdi-email-open"></i>Email</button></div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <h5 class="text-center">Atau</h5>
                                ...
                                <div class="col-5">
                                    <p class="text-center">Undang anggota keluargamu dengan <br> QR dibawah ini
                                    </p><img src="{{ asset('image/qrcode.jpeg') }}" alt=""
                                    ...
                                    <table id="tableIuran" class="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Rp.500.000</td>
                                                <td>
                                                    <span class="badge badge-boxed badge-info">Belum bayar</span>
                                                </td>
                                                <td>
                        ...
                        <!-- Panel Keuangan -->
                        <div class="tab-pane p-3" id="role-5" role="tabpanel">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <div class="d-flex justify-content-end px-3 py-3 mb-0">
                                        <i class="mdi mdi-calendar-today mr-2" style="font-size: 30px"></i>
                        ...
                        <!-- Panel Surat -->
                        <div class="tab-pane p-3" id="role-6" role="tabpanel">
                            <div class="card ">
                                <div class="card-body">
                                        ...
                                        @foreach ($informasi as $dataInfo)
                                            <div class="col-lg-4">
                                                <div class="card card-body">
                                                    <h4 class="card-title mt-0">{{ $dataInfo->judul_informasi }}
                                                    </h4>
                                                    <p class="card-text text-muted font-13">
                                                        {{ Str::limit($dataInfo->deskripsi_singkat, 150) }}
                                                    </p>
                                                    <a href="{{ route('informasi.show', $dataInfo['id']) }}"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card card-body">
                                                    <h4 class="card-title mt-0">
                                                        {{ $detailInformasi['judul_informasi'] }}</h4>
                                                    <p class="card-text text-muted font-13">
                                                        {{ Str::limit($detailInformasi['deskripsi_singkat'], 150) }}
                                                    </p>
