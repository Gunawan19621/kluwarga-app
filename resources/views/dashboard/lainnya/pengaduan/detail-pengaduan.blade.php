        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            <label for="name" class="col-form-label">Nama Pengirim</label>
                            <h6>{{ $pengaduan->pengguna->user->name }}</h6>
            ...
            <form action="{{ route('pengaduan.update', $pengaduan['id']) }}" id="form-update-akun" method="POST">
                @method('PATCH')
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-success px-4 float-right" onclick="submit()">SIMPAN</button>
                        <button type="button" class="btn btn-danger px-4 float-right mr-2"
                            onclick="window.location.href='{{ route('pengaduan.index') }}'">BATAL</button>
                    </div>
                </div>
            </form>
        </div>
