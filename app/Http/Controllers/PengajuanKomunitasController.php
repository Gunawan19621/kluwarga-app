...
class PengajuanKomunitasController extends Controller
{
    ...
    //     $getKomunitas = $komunitas->nama_komunitas;
    //     $pengajuanKomunitas = PengajuanKomunitas::query()->latest()->first();
    //     return view('dashboard.komunitas.gabung', compact('komunitas', 'getKomunitas', 'pengajuanKomunitas'));
    // }
